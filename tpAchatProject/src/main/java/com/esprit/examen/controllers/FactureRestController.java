...
public class FactureRestController {
    ...
    //http://localhost:8089/SpringMVC/facture/calculate/
    @GetMapping("/calculate")
    public BigDecimal calculateInvoiceTotal(@RequestBody List<Long> idsDetailFacture) {
        return factureService.calculerTotalFactureAvancee(idsDetailFacture);
    }
